...
class RTS_Shortcodes {
        ...
        <div class="rts-onboarding-overlay" style="display:none;" aria-hidden="true">
            ...
            <style>
                ...
                .rts-onboarding-overlay {
                    ...
                    background: rgba(0,0,0,0.85); /* Slightly darker overlay for focus */
                    z-index: 9999;
                    display: flex;
                    align-items: center;
                ...
                .rts-onboarding-modal {
                    background: linear-gradient(135deg, #FFFFFF 0%, var(--brand-cream) 120%);
                    background-image: 
                ...
                .rts-onboarding-modal::before {
                    ...
                    height: 4px;
                    background: linear-gradient(90deg, var(--brand-gold), #FFE5B4);
                ...
                /* --- Form Elements --- */
                .rts-checkbox-group, .rts-radio-group {
                    display: flex;
                ...
                .rts-checkbox-label, .rts-radio-label {
                    display: flex;
                    align-items: center;
                    padding: 12px 16px;
                ...
                .rts-checkbox-label:hover, .rts-radio-label:hover {
                    border-color: #9CA3AF;
                ...
                .rts-checkbox-label.selected, .rts-radio-label.selected {
                    background-color: var(--black);
                    border-color: var(--black);
                    color: #FFFFFF !important;
                }

                .rts-checkbox-label input, .rts-radio-label input {
                    position: absolute;
                    opacity: 0;
                    height: 0; width: 0;
                }
                ...
                /* Indicators */
                .rts-checkbox-label span::before, .rts-radio-label span::before {
                    content: '';
                ...
                .rts-btn-complete {
                    background: linear-gradient(135deg, var(--brand-gold), #e5940e);
                    color: var(--black);
                    border: none;
                ...
                .rts-btn-complete:hover {
                    ...
                    background: linear-gradient(135deg, #e5940e, var(--brand-gold));
                }
                ...
                @media (max-width: 767px) {
                    ...
                    .rts-step-footer { flex-direction: column-reverse; gap: 15px; }
                    .rts-btn { width: 100%; }
                }
            </style>
    ...
    public function submit_form($atts) {
        ...
        <style>
            /* Scoped to this shortcode to avoid conflicts with onboarding checkbox styles */
            ...
            .rts-form{background:#ffffff;border-radius:28px;padding:50px;box-shadow:0 10px 30px rgba(0,0,0,0.08);}
            ...
            .rts-btn{margin-top:22px;width:100%;border:none;border-radius:12px;padding:14px 16px;font-size:1.05rem;cursor:pointer;transition:transform .15s ease,box-shadow .15s ease,background .15s ease;}
